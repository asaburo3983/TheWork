...
void imguiDX12::ManagerImGui::CreateSRVHeap() {
...
void imguiDX12::ManagerImGui::Init() {
...
void imguiDX12::ManagerImGui::UnInit() {
    ImGui_ImplDX12_Shutdown();
    ImGui_ImplWin32_Shutdown();
    ImGui::DestroyContext();
}
void imguiDX12::ManagerImGui::DrawStart() {
    ImGui_ImplDX12_NewFrame();
    ImGui_ImplWin32_NewFrame();
    ImGui::NewFrame();
}
void imguiDX12::ManagerImGui::DrawFinish() {
    auto lowApp = LowApplication::GetInstance();
    ImGui::Render();
...
void imguiDX12::ManagerImGui::Test() {
